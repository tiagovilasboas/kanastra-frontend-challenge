...
if (!envExists) {
  ...
  console.log('📝 Crie um arquivo .env na raiz do projeto baseado no env.example')
  console.log('💡 Exemplo:')
  console.log('   cp env.example .env')
  console.log('   # Depois edite o arquivo .env com suas credenciais do Spotify\n')
  process.exit(1)
}
...
for (const varName of requiredVars) {
  ...
  if (!line) {
    ...
    if (!value || value === 'your_spotify_client_id_here' || value === 'your_spotify_client_secret_here') {
...
if (missingVars.length === 0 && emptyVars.length === 0) {
  ...
  console.log('4. Configure a Redirect URI como: http://127.0.0.1:5173/callback')
