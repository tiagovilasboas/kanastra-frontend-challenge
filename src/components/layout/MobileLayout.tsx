...
export const MobileLayout: React.FC<MobileLayoutProps> = () => {
  ...
  const [activeSection, setActiveSection] = useState<'home' | 'search' | 'library' | 'download' | 'profile'>('home')
      ...
      <main className="mobile-main-content">
        ...
        {activeSection === 'library' && (
          <div className="mobile-library-content">
            ...
            <p>{t('navigation:libraryMessage', 'Sua biblioteca de músicas aparecerá aqui')}</p>
          </div>
        )}
        ...
        {activeSection === 'download' && (
          <div className="mobile-download-content">
            ...
            <p>{t('navigation:downloadMessage', 'Baixe o aplicativo para ouvir offline')}</p>
          </div>
        )}
        ...
        {activeSection === 'profile' && (
          <div className="mobile-profile-content">
            ...
            <p>{t('navigation:profileMessage', 'Gerencie sua conta e configurações')}</p>
          </div>
        )}
      </main>
